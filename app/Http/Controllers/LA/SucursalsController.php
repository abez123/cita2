...
class SucursalsController extends Controller
{
	...
	public $listing_cols = ['id', 'nombresuc', 'domicilio', 'lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo', 'horarioabierto', 'horariocerrado', 'domingohorarioab', 'domingohorariocer', 'telefono', 'sucursal_id'];
