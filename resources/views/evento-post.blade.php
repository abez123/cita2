...
@include('layouts.partials.navmenu')  
  ...
  <div class="profile-bnr sub-bnr user-profile-bnr">
    <div class="position-center-center">
      <div class="container">
        <h2>Eventos AMCHAM Guadalajara</h2>
      </div>
    </div>
  </div>
  ...
  <div class="blog-content pt60">
    <div class="container">
      <div class="row">
        ...
        <?php $imgs = \App\Models\Upload::find($eventos->logo); ?>
          <article class="uou-block-7f blog-post-content">
            ...
            <h5>Fecha del Evento: {{$eventos->fecha}}</h5>

            <h5>Tipo de Evento: {{$eventos->tipo}}
            </h5>

            <p>Cuato Socios: ${{$eventos->cuotasocio}}</p>
            <p>Cuato No Socios: ${{$eventos->cuotanosocio}}</p>
            <p>Ubicación: {!!$eventos->ubicacion!!}</p>
