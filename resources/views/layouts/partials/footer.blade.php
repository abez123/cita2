...
Tweets by @todoparasuspies
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <ul class="photos-list">
          <li><img src="../public/socio-assets/images/photostream4.jpg" alt=""></li>
          <li><img src="../public/socio-assets/images/photostream6.jpg" alt=""></li>
          <li><img src="../public/socio-assets/images/photostream3.jpg" alt=""></li>
          <li><img src="../public/socio-assets/images/photostream2.jpg" alt=""></li>
          <li><img src="../public/socio-assets/images/photostream1.jpg" alt=""></li>
          <li><img src="../public/socio-assets/images/photostream.jpg" alt=""></li>
        </ul>
      </div>
      <div class="col-md-3 col-sm-6">
        <h5>Newsletter</h5>
