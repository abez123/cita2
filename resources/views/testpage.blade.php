                    ...
                    <div class="profile-main">
                      ...
                      <div class="profile-in">
                        <div class="media-left">
                          <div class="img-profile"> <img class="media-object" src="/socio-assets/images//avatar-1.jpg" alt=""> </div>
                        </div>
                  ...
                  <div class="col-md-8"> 
                    ...
                    <div class="sidebar">
                      ...
                      <div class="similar">
                        <div class="media">
                          <div class="media-left">
                            <div class="inn-simi"> <img class="media-object" src="/socio-assets/images//med-avatar.jpg" alt=""> <a href="#">Profile </a> </div>
                          </div>
                          <div class="media-body">
                            <h5>Media heading</h5>
             ...
             <div id="Paris" class="tabcontent">
                ...
                <div class="listing listing-1">
                  <div class="listing-section">
                    @foreach($comitesmiembros as $comitesmiembro)
                    <div class="listing-ver-3">
                      <div class="listing-heading">
                        <h5>Comité: {{$comitesmiembro->nombre}}</h5>
                      ...
                      <div class="listing-inner">
                        <div class="listing-content">
                          <h6 class="title-company">Descripción: {{$comitesmiembro->descripcion}}</h6>
                         <p>Objetivos: {!!$comitesmiembro->objetivos!!}</p>
                          <p>Temas: {!!$comitesmiembro->temas!!} <a href="#">leer más</a></p>
                          <h6 class="title-tags">Miembros:</h6>
                          <ul class="tags list-inline">
                            <li><a href="#">{{$comitesmiembro->name}}</a></li>
                      ...
                      <div class="listing-tabs">
                        <ul>
                          ...
                          <li><a href="#"><i class="fa fa-globe"></i> Presidente:  {{$comitesmiembro->presidente}}</a></li>
                 ...
                 <!-- Comites No Miembro -->
              <div id="comitesnomiem" class="tab-pane fade">
                <div class="header-listing">
                  <h6>Sort by</h6>
                  <div class="custom-select-box">
                    <select name="order" class="custom-select">
                ...
                <div class="listing listing-1">
                  <div class="listing-section">
                    @foreach($comitesnomiembros as $comitesmiembro)
                    <div class="listing-ver-3">
                      <div class="listing-heading">
                        <h5>Comité: {{$comitesmiembro->nombre}}</h5>
                        <ul class="bookmark list-inline">
                        ...
                        <li>
                          <div class="row">
                            <div class="col-xs-4"> 
                              ...
                              <!-- Name -->
                              <div class="fol-name">
                                <div class="avatar"> <img src="/socio-assets/images//sm-avatar.jpg" alt=""> </div>
